...
public class RemovePackageDisplayServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            ...
            String deletePackageFlightQuery = "DELETE FROM package_flight WHERE package_id = '" + packageIdToDelete + "'";
            statement.executeUpdate(deletePackageFlightQuery);

            // Delete the package_hotel entries related to the package
            String deletePackageHotelQuery = "DELETE FROM package_hotel WHERE package_id = '" + packageIdToDelete + "'";
            statement.executeUpdate(deletePackageHotelQuery);

            // Delete the package_activity entries related to the package
            String deletePackageActivityQuery = "DELETE FROM package_activity WHERE package_id = '" + packageIdToDelete + "'";
            statement.executeUpdate(deletePackageActivityQuery);

            // Delete the package from the travel_package table
            String deletePackageQuery = "DELETE FROM travel_package WHERE package_id = '" + packageIdToDelete + "'";
            statement.executeUpdate(deletePackageQuery);
